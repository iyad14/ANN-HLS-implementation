...
entity Forward_propagation_control_s_axi is
generic (
...
port (
    ...
    ap_return             :in   STD_LOGIC_VECTOR(9 downto 0);
    X                     :out  STD_LOGIC_VECTOR(63 downto 0)
);
end entity Forward_propagation_control_s_axi;
...
architecture behave of Forward_propagation_control_s_axi is
    ...
    signal int_ap_return       : UNSIGNED(9 downto 0);
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_AP_RETURN_0 =>
                        rdata_data <= RESIZE(int_ap_return(9 downto 0), 32);
                    when ADDR_X_DATA_0 =>
