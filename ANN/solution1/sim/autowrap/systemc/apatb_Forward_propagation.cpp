...
extern "C" int Forward_propagation_hw_stub_wrapper(volatile void *);

extern "C" int apatb_Forward_propagation_hw(volatile void * __xlx_apatb_param_X) {
...
tr.import<4>((char*)__xlx_apatb_param_X, 9, 0);
  }
aesl_fh.write(AUTOTB_TVIN_X, tr.p, tr.tbytes);
}

  tcl_file.set_num(9, &tcl_file.X_depth);
#else
...
int ap_return = Forward_propagation_hw_stub_wrapper(__xlx_apatb_param_X);
