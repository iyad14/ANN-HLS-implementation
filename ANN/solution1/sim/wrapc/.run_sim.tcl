...
# ==============================================================
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis_HLS/2022.1/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis_HLS/2022.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis_HLS/2022.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vitis_HLS/2022.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Forward_propagation.autotvin.dat"
	set constFileTvOut       "Forward_propagation.autotvout.dat"
	set constFileHdlTvIn     "Forward_propagation.autohdltvin.dat"
	set constFileHdlTvOut    "Forward_propagation.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
