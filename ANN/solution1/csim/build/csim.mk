...
HLS_SOURCES = ../../../../main.cpp ../../../../Forward_propagation.cpp
...
$(ObjDir)/Forward_propagation.o: ../../../../Forward_propagation.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../Forward_propagation.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/Forward_propagation.d
